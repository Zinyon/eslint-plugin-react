  ...
  invalid: [
    {
      code: `const Test = (props) => {
        return (
          <div>
            {useContext(someContext).test}
          </div>
        );
      }`,
      options: ['always'],
      errors: [{ message: 'Must use destructuring useContext assignment' }],
    },
    {
      code: `const Test = (props) => {
        const {foo} = useContext(someContext);
      ...
      options: ['never'],
      errors: [{ message: 'Must never use destructuring useContext assignment' }],
    },
  ],
  //{
  //   code: `const MyComponent = (props) => {
